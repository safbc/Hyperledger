...
class PoolUtils {
    companion object {
        ...
        private fun createGenesisTxnFile(filename: String, nodesCnt: Int = 4): File {
        ...
        fun createPoolLedgerConfig(nodesCnt: Int = 4): String {
            createPoolLedgerConfig(DEFAULT_POOL_NAME, nodesCnt)
            return DEFAULT_POOL_NAME
        }

        private fun createPoolLedgerConfig(poolName: String, nodesCnt: Int) {
